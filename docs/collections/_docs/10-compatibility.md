...
| [`Add-PASOAuthProvider`][Add-PASOAuthProvider]                                             | **15.0**                                                                                                      | Adds a new OAuth 2.0 provider                                    |
| [`Get-PASOAuthProvider`][Get-PASOAuthProvider]                                             | **15.0**                                                                                                      | Gets configured OAuth 2.0 providers                              |
| [`Set-PASOAuthProvider`][Set-PASOAuthProvider]                                             | **15.0**                                                                                                      | Updates an OAuth 2.0 provider                                    |
| [`Remove-PASOAuthProvider`][Remove-PASOAuthProvider]                                       | **15.0**                                                                                                      | Deletes a configured OAuth Identity Provider                     |
| [`Clear-PASDependentLinkedAccount`][Clear-PASDependentLinkedAccount]                       | **P Cloud** / **15.0** Self-Hosted ([Notes](#clear-pasdependentlinkedaccount--set-pasdependentlinkedaccount)) | Clears a linked account from a dependent account                 |
| [`Set-PASDependentLinkedAccount`][Set-PASDependentLinkedAccount]                           | **P Cloud** / **15.0** Self-Hosted ([Notes](#clear-pasdependentlinkedaccount--set-pasdependentlinkedaccount)) | Sets a linked account for a dependent account                    |
| [`Disable-PASBYOKConfig`][Disable-PASBYOKConfig]                                           | **P Cloud Only**                                                                                              | Disables BYOK for the Privilege Cloud environment                |
| [`Enable-PASBYOKConfig`][Enable-PASBYOKConfig]                                             | **P Cloud Only**                                                                                              | Enables BYOK for the Privilege Cloud environment                 |
| [`Set-PASBYOKConfig`][Set-PASBYOKConfig]                                                   | **P Cloud Only**                                                                                              | Configures BYOK for the Privilege Cloud environment              |
| [`Invoke-PASBYOKRotation`][Invoke-PASBYOKRotation]                                         | **P Cloud Only**                                                                                              | Rotates the customer-managed AWS KMS key used for BYOK           |
| [`Get-PASBYOKPolicyStatement`][Get-PASBYOKPolicyStatement]                                 | **P Cloud Only**                                                                                              | Retrieves the AWS KMS key policy statements required for BYOK    |
| [`Export-PASTicketingSystemLog`][Export-PASTicketingSystemLog]                             | **P Cloud Only**                                                                                              | Export ticketing system logs from Privilege Cloud                |
| [`Import-PASTicketingSystem`][Import-PASTicketingSystem]                                   | **P Cloud Only**                                                                                              | Imports a ticketing system into Privilege Cloud                  |
| [`Get-PASReportActivity`][Get-PASReportActivity]                                           | **15.0**                                                                                                      | Returns the activity groups/activities available for reports     |
| [`Remove-PASReportTask`][Remove-PASReportTask]                                             | **14.6**                                                                                                      | Removes a report schedule                                        |
| [`Get-PASVRMDRSystemHealth`][Get-PASVRMDRSystemHealth]                                     | **15.0**                                                                                                      | Gets the DR system health check including replication status     |
| [`Get-PASVRMServiceConfig`][Get-PASVRMServiceConfig]                                       | **15.0**                                                                                                      | Gets the current value of a DR configuration parameter           |
| [`Get-PASVRMServiceConfigParameter`][Get-PASVRMServiceConfigParameter]                     | **15.0**                                                                                                      | Gets a specific DR configuration parameter value                 |
| [`Get-PASVRMServiceStatus`][Get-PASVRMServiceStatus]                                       | **15.0**                                                                                                      | Gets the operational status of a Vault service                   |
| [`Set-PASVRMServiceConfig`][Set-PASVRMServiceConfig]                                       | **15.0**                                                                                                      | Sets one or multiple DR configuration parameters                 |
...
| [`Hide-PASDiscoveredLocalAccount`][Hide-PASDiscoveredLocalAccount]                         | **P Cloud Only**                                                                                              | Moves a discovered account to the ignore list                    |
| [`Restore-PASDiscoveredLocalAccount`][Restore-PASDiscoveredLocalAccount]                   | **P Cloud Only**                                                                                              | Removes a discovered account from the ignore list                |
| [`Set-PASDiscoveredLocalAccount`][Set-PASDiscoveredLocalAccount]                           | **P Cloud Only**                                                                                              | Edits properties of a discovered local account                   |
| [`Test-PASDiscoveredLocalAccount`][Test-PASDiscoveredLocalAccount]                         | **P Cloud Only**                                                                                              | Checks discovered account existence in the vault                 |
| [`New-PASDiscoveredAccountObject`][New-PASDiscoveredAccountObject]                         | **---**                                                                                                       | Format an object for use with Test-PASDiscoveredLocalAccount     |
| [`New-PASPlatformSecret`][New-PASPlatformSecret]                                           | **15.2**                                                                                                      | Generates a secret for a platform                                |
| [`Set-PASPlatform`][Set-PASPlatform]                                                       | **15.2**                                                                                                      | Update target platform settings                                  |
...
[Clear-PASDependentLinkedAccount]: /commands/Clear-PASDependentLinkedAccount
[Set-PASDependentLinkedAccount]: /commands/Set-PASDependentLinkedAccount
...
[Export-PASTicketingSystemLog]: /commands/Export-PASTicketingSystemLog
[Import-PASTicketingSystem]: /commands/Import-PASTicketingSystem
[Get-PASReportActivity]: /commands/Get-PASReportActivity
[Remove-PASReportTask]: /commands/Remove-PASReportTask
[Get-PASVRMDRSystemHealth]: /commands/Get-PASVRMDRSystemHealth
[Get-PASVRMServiceConfig]: /commands/Get-PASVRMServiceConfig
[Get-PASVRMServiceConfigParameter]: /commands/Get-PASVRMServiceConfigParameter
[Get-PASVRMServiceStatus]: /commands/Get-PASVRMServiceStatus
[Set-PASVRMServiceConfig]: /commands/Set-PASVRMServiceConfig
[Start-PASVRMService]: /commands/Start-PASVRMService
[Stop-PASVRMService]: /commands/Stop-PASVRMService
[Restart-PASVRMService]: /commands/Restart-PASVRMService
[Invoke-PASVRMFailover]: /commands/Invoke-PASVRMFailover
...
[New-PASDiscoveredAccountObject]: /commands/New-PASDiscoveredAccountObject
...
- Supported against Privilege Cloud with no minimum version requirement.
- Version 15.0 introduced support for Self-Hosted environments, available via the `SelfHosted` parameter set.
