...
Add-PASAccount [-name <String>] [-address <String>] [-userName <String>] -platformID <String>
 ...
 [-accessRestrictedToRemoteMachines <Boolean>] [-AllowAccountDuplications <Boolean>] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```
...
Add-PASAccount [-address <String>] -userName <String> -platformID <String> -SafeName <String>
 ...
 [-ExtraPass3Folder <String>] [-ExtraPass3Safe <String>] [-DynamicProperties <Hashtable>] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```
