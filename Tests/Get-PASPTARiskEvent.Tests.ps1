    ...
    InModuleScope $(Split-Path (Split-Path (Split-Path -Parent $PSCommandPath) -Parent) -Leaf ) {
        ...
        Context 'Input' {
            ...
            It 'uses expected date filter - date range' {
                Get-PASPTARiskEvent -FromTime (Get-Date -Year 1979 -Month 11 -Day 12 -Hour 0 -Minute 0 -Second 0) -ToTime (Get-Date -Year 2023 -Day 22 -Month 1 -Hour 0 -Minute 0 -Second )
            ...
            It 'uses expected date filter - before date' {
                Get-PASPTARiskEvent -ToTime (Get-Date -Year 2023 -Day 22 -Month 1 -Hour 0 -Minute 0 -Second ) #1674345600000
                Assert-MockCalled Invoke-PASRestMethod -ParameterFilter {
            ...
            It 'uses expected date filter - after date' {
                Get-PASPTARiskEvent -FromTime (Get-Date -Year 2023 -Day 22 -Month 1 -Hour 0 -Minute 0 -Second ) #1674345600000
                Assert-MockCalled Invoke-PASRestMethod -ParameterFilter {
