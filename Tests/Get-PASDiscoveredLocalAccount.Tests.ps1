Describe $($PSCommandPath -Replace '.Tests.ps1') {
    ...
    InModuleScope $(Split-Path (Split-Path (Split-Path -Parent $PSCommandPath) -Parent) -Leaf ) {
        ...
        BeforeEach {
            ...
            $response = Get-PASDiscoveredLocalAccount
        ...
        Context 'Input' {
            ...
            It 'sends request to expected endpoint' {
                ...
                Assert-MockCalled Invoke-PASRestMethod -ParameterFilter {
                    ...
                    $URI -eq "$($Script:psPASSession.ApiURI)/api/discovered-accounts"
            ...
            It 'sends request to expected endpoint - byQuery' {

                Get-PASDiscoveredLocalAccount -search 'SomeSearch'

                Assert-MockCalled Invoke-PASRestMethod -ParameterFilter {

                    $URI -eq "$($Script:psPASSession.ApiURI)/api/discovered-accounts?search=SomeSearch"
