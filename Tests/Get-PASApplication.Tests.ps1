		...
		Context 'Input' {
			...
			It 'sends request to expected endpoint (byAppID ParameterSet)' {
				...
				Assert-MockCalled Invoke-PASRestMethod -ParameterFilter {
					...
					$URI -eq "$($Script:psPASSession.BaseURI)/WebServices/PIMServices.svc/Applications/SomeApplication/"
			...
			It 'sends request to expected endpoint (byQuery ParameterSet)' {
				...
				Assert-MockCalled Invoke-PASRestMethod -ParameterFilter {
					...
					$URI -eq "$($Script:psPASSession.BaseURI)/WebServices/PIMServices.svc/Applications?AppID=SomeApplication"
