...
.EXAMPLE
$token | Get-PASPSMSessionProperty -liveSessionId 123_45
...
#>
	...
	PROCESS {
		...
		$URI = "$baseURI/$PVWAAppName/API/LiveSessions/$($liveSessionId | Get-EscapedString)/properties"
		...
		If($result) {
			...
			Add-ObjectDetail -typename psPAS.CyberArk.Vault.PSM.Session.Property -PropertyToAdd @{
